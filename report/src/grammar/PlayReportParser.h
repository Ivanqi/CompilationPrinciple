...
class  PlayReportParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    RuleBracedExpression = 0, RuleExpression = 1, RulePrimary = 2, RuleExpressionList = 3, 
    RuleFunctionCall = 4, RuleLiteral = 5, RuleIntegerLiteral = 6, RuleFloatLiteral = 7
  };

  PlayReportParser(antlr4::TokenStream *input);
  ~PlayReportParser();
  ...
  class  BracedExpressionContext : public antlr4::ParserRuleContext {
  public:
    BracedExpressionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
  ...
  BracedExpressionContext* bracedExpression();
